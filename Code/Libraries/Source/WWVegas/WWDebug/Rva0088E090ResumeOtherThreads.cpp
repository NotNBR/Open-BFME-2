...
// Retail reaches kernel32!CloseHandle at the close slot (IAT 0x00BBA180), so
// the real import name is declared instead of the donor's TU-local alias.
extern "C" __declspec(dllimport) int __stdcall CloseHandle(RvaHandle handle);
