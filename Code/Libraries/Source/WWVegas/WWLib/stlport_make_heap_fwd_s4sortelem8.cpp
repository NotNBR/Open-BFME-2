...
// _STL::__make_heap<S4SortElem8 *, S4Cmp00625BB0>,
// retail 0x00626090, 28 bytes.  Public three-argument heap build: forwards to
// the matched five-argument worker at 0x00625F30 with NULL type/distance tags
// plus the stateful comparator (no new pins).  Twin of the descending
// wrapper at 0x006260B0.
...
template void __make_heap<S4SortElem8 *, S4Cmp00625BB0>(
