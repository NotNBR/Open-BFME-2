...
/* BFME2 links the CRT directly here (retail import slots are
   msvcr71!strncpy/strncat); the explicit terminations below already do the
   strz* job, so map to the plain CRT calls with no added stores. */
#define strzcpy strncpy
#define strzcat strncat
