...
// TU-local view drops the virtuals: retail's outlined copy ctor copies the
// vfptr word from the source as plain data, which only a non-polymorphic
// view emits. The real class's virtuals live at vftable 0x011129B4.
