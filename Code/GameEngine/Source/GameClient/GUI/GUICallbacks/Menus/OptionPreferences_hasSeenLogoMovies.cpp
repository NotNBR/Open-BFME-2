...
// stlport
//
// ?hasSeenLogoMovies@OptionPreferences@@QAE_NXZ, retail 0x002E498F,
// 92 bytes. Dedicated TU.
//
// BFME1 OptionPreferences::hasSeenLogoMovies verbatim
// (reference/open-bfme-1 Code/GameEngine/Source/Common/OptionPreferencesFlags.cpp:
// key "HasSeenLogoMovies", miss-false, _strcmpi against "yes"). Same string
...
public:
	...
	Bool hasSeenLogoMovies();
};

Bool OptionPreferences::hasSeenLogoMovies(void)
{
	OptionPreferences::const_iterator it = find("HasSeenLogoMovies");
	if (it == end())
		return false;
