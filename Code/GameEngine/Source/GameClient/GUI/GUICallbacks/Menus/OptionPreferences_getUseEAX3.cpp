...
// stlport
//
// ?getUseEAX3@OptionPreferences@@QAE_NXZ, retail 0x002E4E76,
// 91 bytes. Dedicated TU.
//
// ZH OptionPreferences getter shape (GeneralsMD/.../GUICallbacks/Menus/
// OptionsMenu.cpp) via the getAllHealthBars twin (same plumbing; the miss
// default is false; the yes/no test calls strcmp through the CRT thunk at
// 0x006291C6).
...
// ?getUseEAX3@OptionPreferences@@QAE_NXZ
Bool OptionPreferences::getUseEAX3(void)
{
	OptionPreferences::const_iterator it = find("UseEAX3");
	if (it == end())
		return false;
