...
// stlport
//
// ?setMaxPing@QuickMatchPreferences@@QAEXH@Z, retail 0x005DFAB3,
// 121 bytes. Dedicated TU.
//
// ZH QuickMatchPreferences::setMaxPing shape (format plus map assign)
...
void QuickMatchPreferences::setMaxPing(Int value)
{
	AsciiString strVal;
