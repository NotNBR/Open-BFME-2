...
// stlport
//
// ?setMaxDisconnects@QuickMatchPreferences@@QAEXH@Z, retail 0x005DF856,
// 121 bytes. Dedicated TU.
//
// ZH QuickMatchPreferences::setMaxDisconnects shape (format plus map assign)
...
void QuickMatchPreferences::setMaxDisconnects(Int value)
{
	...
	AsciiString key("MaxDisconnects");
