// cl: /O1 /GX /DNDEBUG /MD
//
// ?friend_newModuleInstance@PrisonDockUpdate@@SAPAVModule@@PAVThing@@PBVModuleData@@@Z,
...
// ?friend_newModuleInstance@PrisonDockUpdate@@SAPAVModule@@PAVThing@@PBVModuleData@@@Z
Module *PrisonDockUpdate::friend_newModuleInstance(Thing *thing, const ModuleData *moduleData)
{
	return reinterpret_cast<Module *>(new PrisonDockUpdate(thing, moduleData));
}
