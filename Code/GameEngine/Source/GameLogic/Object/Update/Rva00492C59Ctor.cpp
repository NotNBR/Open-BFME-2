...
// stlport
//
// ??0Rva00492C59@@QAE@PAVThing@@PBVModuleData@@@Z at
// retail 0x00492C59 (47B). Opaque-base pattern (unidentified 0x88-byte
...
// 0xC4EB30 / 0xC4E184). No trailing members (factory stub news 0x88).
// Identity unproven (opaque Rva name); serves the 0x24DBD0 factory stub.
class Thing;
class ModuleData;
...
class Rva00492C59 : public Rva0044EF5E
{
public:
	Rva00492C59(Thing *thing, const ModuleData *moduleData);
	virtual ~Rva00492C59();
};

Rva00492C59::Rva00492C59(Thing *thing, const ModuleData *moduleData)
