// cl: /GX- /GS
// Ported from Open-BFME-1 Code/GameNetwork/Rva00800A40Owner.cpp (BFME1
// byte-identical donor b1 0x00800A40, 225B @0x0066CE20). Small repair only:
// BFME1 hardcoded string addresses replaced with BFME2 string literals
// (retail proves: 0xCE3AFC="addr->GetType() == AddressInternet",
// 0xCE3A90="\\views\\feslbuild_main\\jabba\\fesl\\source\\gamebrowser\\gamebrowserdemangler.cpp",
// 0xBBC410="false"). All logic, layout, and // cl: preserved verbatim.
	...
	void *input, unsigned char flag, volatile int value)
{
	...
	if (record.m_04 != 0)
		reinterpret_cast<Rva00800A40Diag *>(Rva007EB810Get())->fail(
			"addr->GetType() == AddressInternet", "\\views\\feslbuild_main\\jabba\\fesl\\source\\gamebrowser\\gamebrowserdemangler.cpp", 0x4d);
	...
	{
		reinterpret_cast<Rva00800A40Diag *>(Rva007EB810Get())->fail(
			"false", "\\views\\feslbuild_main\\jabba\\fesl\\source\\gamebrowser\\gamebrowserdemangler.cpp", 0x54);
