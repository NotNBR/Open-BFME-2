...
BFME_DISP8_BYTE_GETTER(Rva005505DFByteField, 0x52)
BFME_DISP8_BYTE_GETTER(Rva0056A99FByteField, 0x26)
BFME_DISP8_BYTE_GETTER(Rva00578522ByteField, 0x50)
BFME_DISP8_BYTE_GETTER(Rva00578526ByteField, 0x51)
BFME_DISP8_BYTE_GETTER(Rva0057852AByteField, 0x3E)
BFME_DISP8_BYTE_GETTER(Rva0057852EByteField, 0x3F)
BFME_DISP8_BYTE_GETTER(Rva0057A3D3ByteField, 0x48)
BFME_DISP8_BYTE_GETTER(Rva005C4135ByteField, 0x62)
BFME_DISP8_BYTE_GETTER(Rva005C4139ByteField, 0x63)
BFME_DISP8_BYTE_GETTER(Rva005C4AE5ByteField, 0x54)
BFME_DISP8_BYTE_GETTER(Rva005CD5F6ByteField, 0x0C)
BFME_DISP8_BYTE_GETTER(Rva005EE2CBByteField, 0x1A)
BFME_DISP8_BYTE_GETTER(Rva0011C430ByteField, 0x18)
BFME_DISP8_BYTE_GETTER(Rva006D89D0ByteField, 0x08)
BFME_DISP8_BYTE_GETTER(Rva005EE2C7ByteField, 0x19)
BFME_DISP8_BYTE_GETTER(Rva005C4131ByteField, 0x61)
BFME_DISP8_BYTE_GETTER(Rva002B235DByteField, 0x75)
BFME_DISP8_BYTE_GETTER(Rva00232E8FByteField, 0x20)
BFME_DISP8_BYTE_GETTER(Rva003FE57DByteField, 0x28)
BFME_DISP8_BYTE_GETTER(Rva0045310DByteField, 0x3C)
