...
BFME_DISP8_BYTE_GETTER(Rva004A0DF8ByteField, 0x66)
BFME_DISP8_BYTE_GETTER(Rva0009853CByteField, 0x2C)
BFME_DISP8_BYTE_GETTER(Rva003ABD51ByteField, 0x3D)
BFME_DISP8_BYTE_GETTER(Rva00049F27ByteField, 0x5D)
BFME_DISP8_BYTE_GETTER(Rva00225A4CByteField, 0x40)
BFME_DISP8_BYTE_GETTER(Rva0008BB8FByteField, 0x74)
BFME_DISP8_BYTE_GETTER(Rva00106CECByteField, 0x05)
BFME_DISP8_BYTE_GETTER(Rva0034B150ByteField, 0x42)
BFME_DISP8_BYTE_GETTER(Rva000421F2ByteField, 0x6D)
BFME_DISP8_BYTE_GETTER(Rva00050CD8ByteField, 0x4B)
BFME_DISP8_BYTE_GETTER(Rva0008541CByteField, 0x2D)
BFME_DISP8_BYTE_GETTER(Rva00149590ByteField, 0x30)
BFME_DISP8_BYTE_GETTER(Rva00179030ByteField, 0x48)
BFME_DISP8_BYTE_GETTER(Rva00179050ByteField, 0x49)
BFME_DISP8_BYTE_GETTER(Rva00196140ByteField, 0x10)
BFME_DISP8_BYTE_GETTER(Rva0019B0E0ByteField, 0x42)
BFME_DISP8_BYTE_GETTER(Rva0028A5F5ByteField, 0x6F)
BFME_DISP8_BYTE_GETTER(Rva002B245BByteField, 0x4E)
BFME_DISP8_BYTE_GETTER(Rva003297EBByteField, 0x39)
BFME_DISP8_BYTE_GETTER(Rva003B8ACBByteField, 0x4D)
BFME_DISP8_BYTE_GETTER(Rva004543DFByteField, 0x16)
BFME_DISP8_BYTE_GETTER(Rva0049002DByteField, 0x0A)
BFME_DISP8_BYTE_GETTER(Rva004EA03AByteField, 0x64)
BFME_DISP8_BYTE_GETTER(Rva00564B06ByteField, 0x55)
BFME_DISP8_BYTE_GETTER(Rva005C4FEBByteField, 0x41)
BFME_DISP8_BYTE_GETTER(Rva005CC936ByteField, 0x23)
BFME_DISP8_BYTE_GETTER(Rva005FD047ByteField, 0x38)
BFME_DISP8_BYTE_GETTER(Rva00614DA0ByteField, 0x01)
BFME_DISP8_BYTE_GETTER(Rva0065D7B0ByteField, 0x1C)
BFME_DISP8_BYTE_GETTER(Rva0065D7D0ByteField, 0x1D)
BFME_DISP8_BYTE_GETTER(Rva00661D30ByteField, 0x14)
BFME_DISP8_BYTE_GETTER(Rva0066D4A0ByteField, 0x25)
BFME_DISP8_BYTE_GETTER(Rva0066D4B0ByteField, 0x24)
BFME_DISP8_BYTE_GETTER(Rva0066D610ByteField, 0x64)
